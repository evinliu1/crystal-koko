      ...
      <div>
        {
          cartData.map((item,index)=>{
            ...
            return (
              <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_1fr] sm:grid-cols-[4fr_2fr_1fr] items-center gap-4">
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-5 mt-2'>
                      ...
                      <p className='px-2 sm:px-3 sm:py-1 border bg-white-700 text-sm'>Nice purchase!</p>
                    </div>
                  </div>
                </div>

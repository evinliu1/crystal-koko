...
const Hero = () => {
  return (
    <div className='relative flex flex-col sm:flex-row justify-center items-center py-20'>
      ...
      <div className='absolute inset-0 bg-pink-200 rounded-lg opacity-80 -z-10 transform -translate-x-4 -translate-y-4 animate-wobble animate-scale mt-4' />
      ...
      <div className='w-full sm:w-1/2 flex flex-col items-center justify-center gap-6'>
        <div className='text-[#414141]'>
          <div className='flex items-center gap-2'>
            ...
            <p className='font-medium text-sm md:text-base'>BEST PRICES</p>
          </div>
      ...
      {/* Hero Right Side */}
      {/* <img className='w-full sm:w-1/2 rounded-corners' src={assets.hero_img} alt="" /> */}
    </div>
  )
}
